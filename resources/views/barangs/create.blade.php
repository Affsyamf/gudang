<x-app-layout>
    <div class="py-12 bg-slate-200 dark:bg-slate-800">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="p-6 dark:bg-slate-900">
                    ...
                    <form action="{{ route('barangs.store') }}" method="POST">
                        @csrf
                        <div class="space-y-6 dark:bg-slate-900">
                            {{-- Kode Barang --}}
                            <div>
                                <label for="kode_barang" class="block text-sm font-medium text-gray-700 mb-1 dark:text-white">Kode Barang</label>
                            ...
                            {{-- Nama Barang --}}
                            <div>
                                <label for="nama_barang" class="block text-sm font-medium text-gray-700 mb-1 dark:text-white">Nama Barang</label>
                                <div class="relative rounded-md shadow-sm">
                                    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                            ...
                            {{-- Satuan --}}
                            <div>
                                <label for="satuan" class="block text-sm font-medium text-gray-700 mb-1 dark:text-white">Satuan</label>
                                <div class="relative rounded-md shadow-sm">
                                     <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
