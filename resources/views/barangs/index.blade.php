            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                        <div>
                            <h1 class="text-3xl font-bold text-slate-800">Manajemen Data Barang</h1>
                            <p class="mt-1 text-sm text-gray-500">Kelola semua data barang yang terdaftar di gudang.</p>
                        </div>
                    ...
                    <div class="mb-4">
                        <div class="relative">
                            ...
                            <input type="text" name="search" id="search" class="block w-full rounded-lg border-gray-300 bg-gray-50 py-2 pl-10 pr-3 focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition duration-150" placeholder="Cari barang...">
                        </div>
                    </div>
                                ...
                                @forelse ($barangs as $barang)
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                            <span class="inline-flex items-center rounded-full bg-purple-100 px-2.5 py-0.5 text-xs font-medium text-purple-800">{{ $barang->satuan }}</span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                            <div class="flex items-center justify-center space-x-2">
                                                <a href="{{ route('barangs.edit', $barang->id) }}" class="text-yellow-600 hover:text-yellow-900" title="Edit">
                                    ...
                                    <tr>
                                        <td colspan="4" class="px-6 py-12 text-center">
                                            <div class="text-center">
                                                ...
                                                <h3 class="mt-2 text-sm font-medium text-gray-900">Belum ada data barang</h3>
                                                <p class="mt-1 text-sm text-gray-500">Silakan mulai dengan menambahkan barang baru.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
