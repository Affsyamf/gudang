<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-xl overflow-hidden">
                <div class="p-6 bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div id="barang-data-container">
                        @include('barangs.barang_table')
                    </div>
    ...
    <script>
        ...
        const tableContainer = document.getElementById('barang-data-container');
        ...
        searchInput.addEventListener('keyup', function() {
            ...
            searchTimeout = setTimeout(() => {
                ...
                const url = `{{ route('barangs.index') }}?search=${encodeURIComponent(query)}`;
                ...
                .then(html => {
                    // Ganti isi kontainer dengan hasil AJAX
                    tableContainer.innerHTML = html;
                    // Inisialisasi ulang script SweetAlert untuk tombol hapus yang baru
